...
public class BoardGen : MonoBehaviour
{
    ...
    {
        Texture2D tex = SpriteUtility.LoadTexture(ImageFilename);
        if (!tex.isReadable)
        {
        ...
        Sprite sprite = SpriteUtility.CreateSpriteFromTexture2D(
            newTex,
            0,
            0,
            newTex.width,
    ...
    void CreateJigsawTiles()
    {
        ...
        print(baseTexture.width);
        print(baseTexture.height);
        print(NumTilesX);
        ...
        for (int i = 0; i < NumTilesX; ++i)
        {
            ...
            {
                Tile tile = new Tile(baseTexture, i*Tile.TileSize, j*Tile.TileSize);
                tile.xIndex = i;
                tile.yIndex = j;
                ...
                else
                {
                    ...
                    tile.SetPosNegType(Tile.Direction.LEFT, rightOp == Tile.PosNegType.NEG ? Tile.PosNegType.NEG : Tile.PosNegType.POS);
                }
