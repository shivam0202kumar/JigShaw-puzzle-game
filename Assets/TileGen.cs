...
public class TileGen : MonoBehaviour
{
    ...
    {
        // Load the main image.
        mTextureOriginal = SpriteUtility.LoadTexture(ImageFilename);
        ...
        spriteRenderer.sprite = SpriteUtility.CreateSpriteFromTexture2D(
            mTextureOriginal,
            0,
            0,
    ...
    void TestTileCurves()
    {
        Tile tile = new Tile(mTextureOriginal, 0,0);
